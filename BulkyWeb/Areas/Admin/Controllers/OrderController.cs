...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            _unitOfWork.Save();
            TempData["succcess"] = "Order Details Updated Successfully.";
        ...
        public IActionResult CancelOrder()
        {
            ...
            TempData["succcess"] = "Order cancelled Successfully.";
        ...
        public IActionResult ShipOrder()
        {
            ...
            _unitOfWork.Save();
            TempData["succcess"] = "Order Ship Successfully.";

            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        }
        [ActionName("Details")]
        [HttpPost]//button submit presmeruje sem lebo je to form post
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    objOrderHeaders = objOrderHeaders.Where(o => o.PaymentStatus == SD.StatusPending);
                    break;
                case "inprocess":
